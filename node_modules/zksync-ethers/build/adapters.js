...
function AdapterL1(Base) {
    return class Adapter extends Base {
        ...
        async finalizeWithdrawal(withdrawalHash, index = 0, overrides) {
            ...
            const l1SharedBridge = typechain_1.IL1SharedBridge__factory.connect(await (await this.getL1BridgeContracts()).shared.getAddress(), this._signerL1());
    ...
    return class Adapter extends Base {
        ...
        async getL2BridgeContracts() {
            ...
            return {
                ...
                shared: typechain_1.IL2Bridge__factory.connect(addresses.sharedL2, this._signerL2()),
            };
        }
