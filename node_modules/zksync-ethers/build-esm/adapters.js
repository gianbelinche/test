...
export function AdapterL1(Base) {
    return class Adapter extends Base {
        ...
        async finalizeWithdrawal(withdrawalHash, index = 0, overrides) {
            ...
            const l1SharedBridge = IL1SharedBridge__factory.connect(await (await this.getL1BridgeContracts()).shared.getAddress(), this._signerL1());
            return await l1SharedBridge.finalizeWithdrawal((await this._providerL2().getNetwork()).chainId, l1BatchNumber, l2MessageIndex, l2TxNumberInBlock, message, proof, overrides ?? {});
        }
        /**
    ...
    return class Adapter extends Base {
        ...
        async getL2BridgeContracts() {
            ...
            return {
                ...
                shared: IL2Bridge__factory.connect(addresses.sharedL2, this._signerL2()),
            };
        }
